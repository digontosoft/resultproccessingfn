...
const Transcript = () => {
  ...
  return (
    <>
      {studentInfo.className === 4 || studentInfo.className === 5 ? (
        <>
      ...
      ) : studentInfo?.className >= 6 && studentInfo?.className <= 9 ? (
        <SixToNineTranscript />
      ) : studentInfo.className === 10 ? (
        <TenTranscript />
      ) : (
        <p>No transcript available for this class.</p>
      )}
    </>
