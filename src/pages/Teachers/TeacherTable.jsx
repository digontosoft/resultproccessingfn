...
//         // Filter for userType = teacher
//         const users = allUsers.filter((user) => user.userType === "teacher");

//         setTeachers(users);
//         console.log("Filtered users (teachers):", users);
//       } catch (error) {
...
//   //   const fetchUsers = async () => {
//   //     try {
//   //       // const response = await axios.get(`${url}/teacher-subs`);
...
//   //       // setTeachers(users);
//   //       console.log("Filtered users (teachers):", allUsers);
//   //     } catch (error) {
//   //       toast.error("Failed to fetch users");
//   //       console.error(error);
//   //     }
