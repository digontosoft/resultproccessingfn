    ...
    <div>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <form className="space-y-4 px-6" onSubmit={handleSubmit(onSubmit)}>
          ...
          <button  className={`inline-flex items-center justify-center bg-primary py-3 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10`} type="submit">Submit</button>
        </form>
      </div>
    </div>
  );
